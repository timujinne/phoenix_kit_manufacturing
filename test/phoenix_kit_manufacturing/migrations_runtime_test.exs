defmodule PhoenixKitManufacturing.MigrationsRuntimeTest do
  ...
  test "reads the version parsed out of the pkm_schema marker" do
    Repo.query!("COMMENT ON TABLE #{@anchor} IS 'pkm_schema:1'")
